...
message.guild.members.cache.get(kisi.id).kick(kisi.id, {reason: sebep})
    ...
    message.react("✅")
    client.users.cache.get(kisi.id).send("Merhaba!**\n" + message.guild.name + " **İsimli Sunucuda** " + sebep + "** Sebebiyle Uyarıldın 2 Kere Daha Küfür Edersen Sunucudan Ban Yersin! https://cdn.discordapp.com/attachments/805457295789916191/827624281273270372/Panda.gif");
